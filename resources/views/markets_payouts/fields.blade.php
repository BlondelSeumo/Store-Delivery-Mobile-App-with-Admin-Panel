...
<div class="form-group row ">
  {!! Form::label('market_id', trans("lang.markets_payout_market_id"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
...
<!-- Method Field -->
<div class="form-group row ">
  {!! Form::label('method', trans("lang.markets_payout_method"),['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
...
<!-- Amount Field -->
<div class="form-group row ">
  {!! Form::label('amount', trans("lang.markets_payout_amount"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
...
<!-- Note Field -->
<div class="form-group row ">
  {!! Form::label('note', trans("lang.markets_payout_note"), ['class' => 'col-3 control-label text-right']) !!}
  <div class="col-9">
