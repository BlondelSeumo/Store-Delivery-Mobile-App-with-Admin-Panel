...
class MarketReviewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('market_reviews')->delete();

        factory(\App\Models\MarketReview::class,20)->create();
        
//        \DB::table('market_reviews')->insert(array (
//            0 =>
//            array (
//                'id' => 1,
